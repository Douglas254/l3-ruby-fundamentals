...
# Note: you can put parenthesis or not its optional e.g puts("Hello world")
...
# 6.0 Arrays
# TODO: Create array natively(common way)
...
# 7.0 Hashes
# TODO: Create Hash
user = {name:"Phanice", age:22, team:"Manchester UTD", residence: "Kibra"}
# puts user
pp user # symbol for name i.e :name to access the key
